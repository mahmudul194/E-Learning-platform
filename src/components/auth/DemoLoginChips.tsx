    ...
    <div className="p-4 rounded-2xl bg-sky-50/70 border border-sky-100 space-y-2.5">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
          ...
          className="p-2 rounded-xl bg-white hover:bg-amber-100/60 border border-amber-200 text-center transition-all hover:scale-105 cursor-pointer shadow-2xs group"
        >
          <UserCheck className="w-4 h-4 text-amber-600 mx-auto mb-1" />
        ...
        <button
          ...
          className="p-2 rounded-xl bg-white hover:bg-rose-100/60 border border-rose-200 text-center transition-all hover:scale-105 cursor-pointer shadow-2xs group"
        >
